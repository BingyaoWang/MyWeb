...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bingyao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'IC designer focused on digital and mixed-signal (AMS) circuit design. B.S. in ECE from The Ohio State University, currently pursuing an M.S. in ECE at Carnegie Mellon University.
', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.wangbingyao.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'IC Design', // 网站关键词 英文逗号隔开
